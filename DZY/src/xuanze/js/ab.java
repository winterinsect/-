...
import static zhandou.zhandoujiemian.dr;
import static zhandou.zhandoujiemian.zhandoujilu;

public class ab extends jueshe {
    public static String name="安柏";
    public static int xl=2000;//这里并没有重写
    public static byte sx=1;//火
    public static byte dh=1;
    public void cx() {}
